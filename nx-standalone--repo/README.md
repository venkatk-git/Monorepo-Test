...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/U9k70K0yRT)
...
```sh
npx nx serve nx-standalone--repo
```

To create a production bundle:

```sh
npx nx build nx-standalone--repo
```

To see all available targets to run for a project, run:

```sh
npx nx show project nx-standalone--repo
```
